...
model = KineticModel(
    name="DA_explicit_DA4_two_int_ss",
    description=textwrap.dedent("""\
        ...
        Orders: k1, K1, EM1, K2, EM2, k2C, k2L; DA1, E, U, DA2, DA3,
        DA4, C.\
        """),
    kin_sys=equations,
    ...
    int_eqn=[
        lambda cs, ks: ((ks[2]*ks[0]*cs[0]*cs[1]) /
                        (ks[2]+ks[1]+cs[0]+cs[3]+cs[4])),
        lambda cs, ks: ks[5]*cs[6],
        lambda cs, ks: (ks[5]*ks[4]*cs[6])/(ks[4]+ks[3]+cs[0]+cs[3]+cs[4]),
        lambda cs, ks: (ks[6]*ks[4]*cs[3])/(ks[4]+ks[3]+cs[0]+cs[3]+cs[4]),
        lambda cs, ks: (ks[6]*ks[4]*cs[4])/(ks[4]+ks[3]+cs[0]+cs[3]+cs[4]),
        lambda cs, ks: (ks[6]*ks[4]*cs[5])/(ks[4]+ks[3]+cs[0]+cs[3]+cs[4]),
        ],
    int_eqn_desc=[
