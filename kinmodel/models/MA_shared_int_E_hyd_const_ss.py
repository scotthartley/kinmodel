...
model = KineticModel(
    ...
    calcs=[
            ...
            lambda cs, ks, ints: (ints[0][1] - ints[2][1])/cs[:, 1][0],
            lambda cs, ks, ints: (ints[3][1] - ints[5][1])/cs[:, 1][0],
            lambda cs, ks, ints: (ints[4][1] + ints[5][1])/cs[:, 1][0],
            lambda cs, ks, ints: ints[2][1]/ints[6][1],
            ],
    calcs_desc=[
            "Maximum An",
            "Final An",
